        ...
        <main>
            ...
            <div class="main-content">
                ...
                <form id="form-food" action="cadastro_alimento_edit_script.php" method="POST">
                    ...
                    <input type="text" name="nome" class="form-control" id="name-food" placeholder="Altere o nome do alimento">
                    </div>
                    <div class="mb-3">
                    <label for="quantity" class="form-label">Quantidade</label>
                    <input type="text" name="quantidade" class="form-control" id="quantity-food" placeholder="Altere a quantidade ">
                    </div>
