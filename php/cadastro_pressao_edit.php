            ...
            <div class="menu">
                <ul>
                    ...
                    <li>
                        ...
                        <a href="gerenciar_pressao_arterial.php"> Gerenciar Pressao Arterial</a>
                    </li>
                    <li>
        ...
        <main>
            ...
            <div class="main-content">
                <div class="main-content-title">
                    <h2>Editar Pressao</h2>
                </div>
                <div class="content" id="ajax-content">
                    <div class="dynamic-content">
                        <form id="form-pressure" action="cadastro_pressao_edit_script.php" method="POST">
                            <div class="mb-3">
                            <label for="pressure" class="form-label">Nova pressao</label>
                            <input type="text" name="pressao" class="form-control" id="pressure-name" placeholder="Altere sua pressao">
                            </div>
                            <button type="submit" class="btn">Salvar Alteracoes</button>
                            <input type="hidden" name="id" value="<?php echo $linha['idPressao']?>">
                        </form>
                    </div>
                </div>
            </div>
